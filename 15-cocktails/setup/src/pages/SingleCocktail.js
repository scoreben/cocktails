    ...
    <section className='section cocktail-section'>
      ...
      <div className='drink'>
        ...
        <div className='drink-info'>
          <p>
            <span className='drink-data'>name:{name}
            </span>
          </p>
          <p>
            <span className='drink-data'>info:{info}
            </span>
          </p>
          <p>
            <span className='drink-data'>glass:{glass}
            </span>
          </p>
          <p>
            <span className='drink-data'>instructions:{instructions}
            </span>
          </p>
          <p>
